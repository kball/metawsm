...
- [x] Migrate grouped command trees (auth check, review sync, forum subcommands)
- [x] Migrate watch/operator/tui loop commands with equivalent signal and runtime behavior
- [x] Remove legacy flag.NewFlagSet switch path and keep compatibility aliases where needed
- [x] Run full regression validation (go test ./..., targeted CLI smoke checks, docs/help updates)
