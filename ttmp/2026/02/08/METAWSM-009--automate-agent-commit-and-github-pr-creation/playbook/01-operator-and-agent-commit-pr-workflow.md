...
RelatedFiles:
    ...
    - Path: internal/orchestrator/service.go
      Note: Implements commit and pull-request service primitives referenced by workflow
ExternalSources: []
Summary: ""
LastUpdated: 2026-02-08T12:25:09.234407-08:00
WhatFor: Repeatable operator workflow for preparing commits and opening GitHub PRs after a run completes.
WhenToUse: Use after a METAWSM run reaches completed state and you want to run commit/PR automation in assist or auto mode.
---
